...
//    if (nameError === false && weightError === false && heightError === false && birthdayError == false && genderError == false && asaError == false) {
//        Swal.fire({
//            icon: 'success',
...
//    if (surgeonError === false && surgeryError === false && anastheasistError === false & anasthesia_typeError === false && theatreError === false && importanceError === false) {
//        Swal.fire({
//            icon: 'success',
