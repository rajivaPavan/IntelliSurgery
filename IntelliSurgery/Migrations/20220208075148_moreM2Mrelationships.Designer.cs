...
namespace IntelliSurgery.Migrations
{
    ...
    [Migration("20220208075148_moreM2Mrelationships")]
    partial class moreM2Mrelationships
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SpecialitySurgeryType", b =>
                {
                    b.Property<int>("SuitableSpecialistsId")
                        .HasColumnType("int");

                    b.Property<int>("SurgeryTypesPerformedId")
                        .HasColumnType("int");

                    b.HasKey("SuitableSpecialistsId", "SurgeryTypesPerformedId");

                    b.HasIndex("SurgeryTypesPerformedId");

                    b.ToTable("SpecialitySurgeryType");
                });
            ...
            modelBuilder.Entity("IntelliSurgery.Models.Appointment", b =>
                {
                    ...
                    b.HasOne("IntelliSurgery.Models.WorkingBlock", "WorkingBlock")
            ...
            modelBuilder.Entity("SpecialitySurgeryType", b =>
                {
                    b.HasOne("IntelliSurgery.Models.Speciality", null)
                        .WithMany()
                        .HasForeignKey("SuitableSpecialistsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("IntelliSurgery.Models.SurgeryType", null)
                        .WithMany()
                        .HasForeignKey("SurgeryTypesPerformedId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
